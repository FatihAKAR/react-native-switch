...
export class Switch extends Component {
  static propTypes = {
    ...
    renderInactiveIcon: PropTypes.func,
  };
  ...
  render() {
    ...
    const activeIcon = circleBorderColor.interpolate({
      inputRange: [-75,75],
      outputRange: [0, 1]
    });

    const inactiveIcon = circleBorderColor.interpolate({
      inputRange: [-75, 75],
      outputRange: [1, 0]
    });
